...
type DataplaneInsight struct {
	...
	MTSL                 *DataplaneInsight_MTLS `protobuf:"bytes,2,opt,name=mTSL,proto3" json:"mTSL,omitempty"`
...
func (m *DataplaneInsight) GetMTSL() *DataplaneInsight_MTLS {
	if m != nil {
		return m.MTSL
	}
	return nil
...
var fileDescriptor_35794f05b529b342 = []byte{
	...
	0xa9, 0x31, 0xe8, 0x6f, 0xfd, 0x06, 0x41, 0xfe, 0xe6, 0xf1, 0x0b, 0x14, 0x0e, 0x0f, 0xfb, 0x07,
	...
	0xda, 0x56, 0x76, 0x9a, 0xca, 0x05, 0x00, 0x00,
}
